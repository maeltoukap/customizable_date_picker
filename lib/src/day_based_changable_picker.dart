...
class _DayBasedChangeablePickerState<T>
    ...
    return StreamBuilder<DayBasedChangeablePickerState>(
        ...
        builder: (context, snapshot) {
          ...
          return MonthNavigationRow(
            ...
            onPreviousMonthTapped: state.isFirstMonth
                ? null
                : _presenter.gotoPrevMonth, //TODO: Change the first month
            onNextMonthTapped: state.isLastMonth
                ? null
                : _presenter.gotoNextMonth, //TODO: Change the last month
            title: Text(
              state.curMonthDis,
  ...
  Widget _buildDayPickerPageView() => PageView.builder(
        ...
        itemCount:
            DatePickerUtils.monthDelta(widget.firstDate, widget.lastDate) +
                1, //FIXME: make animation for many years (50)
  ...
  static DayBasedChangeablePickerPresenter get _defaultPresenter =>
      DayBasedChangeablePickerPresenter(
          ...
          showPrevMonthDates: false, //TODO: make it customizable
          showNextMonthDates: false, //TODO: make it customizable
